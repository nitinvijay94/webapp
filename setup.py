...
dish13.save()
loc1 = Location(address='Student center first floor')
loc1.save()
...
dish23.save()
loc2 = Location(address='Student center first floor')
loc2.save()
...
dish32.save()
loc3 = Location(address='West of Clough')
loc3.save()
...
dish42.save()
loc4 = Location(address='East Campus at 120 N Ave NW')
loc4.save()
...
dish52.save()
loc5 = Location(address='Student center second floor')
loc5.save()
...
dish62.save()
loc6 = Location(address='First floor of Clough')
loc6.save()
